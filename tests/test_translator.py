...
class TestTranslator(unittest.TestCase):
    ...
    def test_should_translate_seconds_and_minutes_star_subexpression(self):
        ...
        translated_expression = Translator.translate_seconds_and_minutes(Expression(sec_and_min_subexpression),
                                                                         CronField.SECOND)
    ...
    def test_should_translate_seconds_and_minutes_list_with_range_within_subexpr_when_a_range_value_is_the_last(self):
    ...
    def test_should_translate_hours_list_with_range_within_subexpression_when_a_range_value_is_the_last(self):
        ...
        translated_expression = Translator.translate_hours(Expression(hours_subexpression), CronField.HOUR)
        self.assertEqual(translated_expression, "at 12:00 AM, 5:00 AM, 10:00 AM through 3:59 PM, and 8:00 PM through "
                                                "11:59 PM")
    ...
    def test_should_translate_month_slash_subexpr_to_every_month_when_the_first_value_is_1_with_alternative_value(self):
    ...
    def test_should_translate_month_list_with_range_within_subexpr_when_range_is_the_last_with_alternative_value(self):
    ...
    def test_should_translate_day_of_week_slash_subexpr_to_every_day_when_first_value_is_1_with_alternative_value(self):
    ...
    def test_should_translate_day_of_week_list_with_range_subexpr_when_range_value_is_last_with_alternative_value(self):
